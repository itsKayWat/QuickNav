const DEFAULT_SHORTCUTKEYS = [
  ...
  { key: 'GD', title: 'Google Drive', action: ActionId.JUMP_URL, url: 'https://drive.google.com' },
  { key: 'YT', title: 'YouTube', action: ActionId.JUMP_URL, url: 'https://youtube.com' },
  { key: 'GH', title: 'GitHub', action: ActionId.JUMP_URL, url: 'https://github.com' },
  { key: 'GC', title: 'Google Calendar', action: ActionId.JUMP_URL, url: 'https://calendar.google.com' }
];
